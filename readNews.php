...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<title>http://gym.amu.edu.et/news</title>
<head>
...
<div id="Menus">		
		<ul>
			...
			<li class="active"><a href="homenews.php">News and Events</a></li>
...
<p>
<font color ="green" ><h2>AMIT Gymnasium</h2><br></font>
<font color="green"><h1>News and and Event</h1></font>
</p></marquee>
</td></tr>
<tr><td>
...
<font color="#336699"><center><h3>News page!</h3></center></font>
<p>
<!-- Main Content-->
<br>
...
<?php
							 if(isset($_REQUEST['key'])){
								 $id= $_REQUEST['key'];
								 $result = mysql_query("SELECT * FROM news where n_id = '$id'");
								while($row = mysql_fetch_array($result))
							    {
								print ("<div style='padding-left:30px; padding-top:10px;color:green;'><a href=''>" .$row['date']."</a><br></div>");
								print ("<div style='color:black;'><prev><p align='justify' style ='padding-left:30px;margin-left:30px; margin-right:30px; font-size:30px; justyfy:justify;'>" . $row['news'] . "</p></prev></div>");
								print ("<center><a href='homenews.php'>Back to News and Events</a></center>");
								}
							 }
