...
<p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<form action="resultse.php" method="get">
...
<tr>
<th style='height:30px;	color:#000;	font-weight:bold;background-color:#336699;'><font color='white' size='2'>Equipement Name</th>
<th style='height:30px;	color:#000;	font-weight:bold;background-color:#336699;'><font color='white' size='2'>Equipement profile</th>
<th style='height:30px;	color:#000;	font-weight:bold;background-color:#336699;'><font color='white' size='2'>Vendors/company</th>
<th style='height:30px;	color:#000;	font-weight:bold;background-color:#336699;'><font color='white' size='2'>Equipement Type</th>
...
<?php
$result = mysql_query("SELECT * FROM equipmenet ORDER BY e_id ASC");
...
<td><img src='ima/profile.PNG' width="25"height="22"></td>
<td><?php echo $vendor;?></td>
<td><?php echo $Etype;?></td>
<td><?php echo $phone;?></td>

						<?php
						print("<td style='height:30px;' align = 'center' width = '1'><a href = 'deletequ.php?key=".$ctrl."'><img width='15px' height='15px' src = 'image/actions-delete.png' title='Delete' onclick='isdelete();'></img></a></td>
		<td style='height:30px;'><a href = 'editeq.php?key=".$ctrl."'><img src = 'image/actions-edit1.png' width='15px' height='15px' title='Edit' ></img></a></td>
		");?>
