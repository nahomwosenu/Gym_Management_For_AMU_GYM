...
<html lang = "eng">
	<head>
		<title>Generate Attendance Record</title>
		<meta charset = "utf-8" />
	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<img src = "admin/images/lolo.png" width = "1300px" height = "100px"/>
		...
		<div class = "navbar navbar-fixed-bottom alert-warning">
			<div class = "container-fluid">
			<li ><a href="admin.php"><h1>Back</h1></a></li>
				<label class = "pull-left">&copy; Attendance Generate Report 2018 Arba Minch University</label>
				<label class = "pull-right">Developed: <a href = "group.php">G4 IT Group 3</a></label>
			</div>	
		</div>	
	</body>
