...
<font color="green" ><h3>Welcome this allow you to uplaod readable text material trainning</h3></font>
...
echo "Return Code: " . $_FILES["file"]["error"] . "<br />";
				...
				echo'<meta content="10;text.php" http-equiv="refresh" />';
				}
		else{
			move_uploaded_file($_FILES["image"]["tmp_name"],"upload/" . $_FILES["image"]["name"]);			
			$location="upload/" . $_FILES["image"]["name"];
			$title=$_POST['title'];
			$sql="INSERT INTO training (location, title,date)
VALUES
('$location','$title','$date')";
