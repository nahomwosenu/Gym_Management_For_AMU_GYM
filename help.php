...
<title>http://gym.amu.edu.et/helps</title>
<head>
...
<div id="Menus">		
		<ul>
			...
			<li class="active"><a href="help.php">Helps</a></li>
...
<img style="border-radius:5px" width="900px" height="200px" src="image/banner.jpg">
</td>
</tr>
...
<p><h3><center><u>Helps</u></center></h3></p>
<p style='text-align:justify;'>
To be the standard user of our system,you have to follow the following First you need to have user name and password,then YOU can use our system.
</p>
<p><h3><center><u>How to Use</u></center></h3></p>
<p style='text-align:justify;'>
A System Admin will create an account for gym trainer.The gym trainer login in to system then create account for the trainee.the end customer can login to our system by using username and password which given by the gym trainer ,you can enter to your own page.
</p>
</marquee>
</td></tr>
<tr><td>
...
<font color="#336699"><center><h3>User Help Page</h3></center></font>
<p>
<!-- Main Content-->
<center>
<h2>Follow the following instraction in order to use the system</h2>
<img width="750px" height="400px" src="image/help.PNG" ></a>
 </center>
<!--End of main content-->
</td>
</tr>
