...
<title>http://gym.amu.edu.et/Schedule</title>
<head>
...
<p><h3><center><u>Schedule</u></center></h3></p>
<p style='text-align:justify;'>
Inoder to view schedule select the day you want and select the train type and click the search button
</p>
</marquee>
</td></tr>
<tr><td>
...
<option value="fitteness">Fitteness</option>
					...
					if(isset($_POST['search']))
 {
					...
					echo'<meta content="5;schedule.php" http-equiv="refresh" />';
					}
					else
					{
					echo"<center>";
					echo"<br><br>";
					echo"<h2><u><center>".$day."  Schedule for&nbsp;".$tgym."</center></u></h2>";
