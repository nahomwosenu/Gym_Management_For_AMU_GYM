...
<font color="#336699"><center><h3>Update Schedule!</h3></center></font>
<p>
<!-- Main Content-->
...
<tr>
<th style='height:30px;	color:#000;	font-weight:bold;background-color:#336699;'><font color='white' size='2'>Day&nbsp;&nbsp;&nbsp;&nbsp;</th>
<th style='height:30px;	color:#000;	font-weight:bold;background-color:#336699;'><font color='white' size='2'>&nbsp;&nbsp;&nbsp;&nbsp;Gym Type &nbsp;&nbsp;&nbsp;&nbsp;</th>
<th style='height:30px;	color:#000;	font-weight:bold;background-color:#336699;'><font color='white' size='2'>Start Time&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
<th style='height:30px;	color:#000;	font-weight:bold;background-color:#336699;'><font color='white' size='2'>End Time&nbsp;&nbsp;&nbsp;&nbsp; </th>
<th style='height:30px;	color:#000;	font-weight:bold;background-color:#336699;'><font color='white' size='2'>&nbsp;&nbsp;&nbsp;Trainer Name&nbsp;&nbsp;</th>
...
<td><?php echo $trainername;?></td>	
						<?php
						print("<td style='height:30px;' align = 'center' width = '1'><a href = 'deleteschedule.php?key=".$ctrl."'><img width='15px' height='15px' src = 'image/actions-delete.png' title='Delete' onclick='isdelete();'></img></a></td>
		<td style='height:30px;'><a href='editschedule.php?key=".$ctrl."'><img src = 'image/actions-edit.png' width='15px' height='15px' title='Edit' ></img></a></td>
		");?>
