...
<tr>
<td>
<img src="image/bullet.png" width="20px">&nbsp;<a href="schedule.php">Schedule</a>
</td>
</tr>
<tr>
<td>
...
<tr><td>User ID:</td><td><input  type='text' id='user_id' name='user_id' value="<?php echo "$r3"?>"></td></tr>
...
?>
 ...
 <?php
  ...
  $update = mysql_query("update member set fname='$fname',lname='$lname',user_id='$user_id', phone='$phone',user_type='$user_type',username='$username' 
	,password='$password'
